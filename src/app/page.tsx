              ...
              return (
                <div key={batch.id} className="rounded-3xl overflow-hidden flex flex-col hover-lift group border border-farm-green-900/10 bg-white/10 backdrop-blur-sm shadow-sm">
                  ...
                  <div className="relative h-64 w-full overflow-hidden">
                    ...
                    {/* Batch Badge */}
                    <span className={`absolute top-4 left-4 rounded-full px-3.5 py-1 text-[10px] uppercase tracking-widest font-semibold text-farm-cream-100 ${
                      batch.isFuture ? "bg-farm-gold-600" : "bg-farm-green-900"
                    }`}>
          ...
          <div className="space-y-16">
            {farmers.map((farmer, idx) => {
              ...
              return (
                <div
                  key={farmer.id}
                  className={`flex flex-col lg:flex-row items-center gap-10 p-8 rounded-3xl bg-white/10 backdrop-blur-sm border border-farm-green-900/10 shadow-sm ${
